(function(){
  ...
  var REPORT_ONE_EVERY_X_LINES = 1000000;

  // Example
  // var sample = require("./lib/sample"); sample.sampleFiles("/Users/shaoshing/Downloads/test/*.txt",
  // "/Users/shaoshing/Downloads/out.txt", 0.5)
  //
      ...
      Sample._countLines(files, function(countResult){
        ...
        for (var i = 0; i < files.length; i++) {
          (function(){
            ...
            var selectedLines = {};
            for (var k = 0; k < numberOfLinesToSelect; k++) {
              selectedLines[lineNumbers[k]] = true;
            }

            var lineIndex = 0;
            Sample.readLines(fileName, function(line){
  ...
  Sample.readLines = function(file, callback, endCallback){
    var fs = require('fs');
    var remaining = '';
